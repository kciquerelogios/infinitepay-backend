...
const S = '${secret}';
const API = '';
const TITLES = {home:'📊 Visão Geral',relatorios:'📑 Relatórios',carrinhos:'🛒 Carrinhos',ofertas:'📣 Ofertas WhatsApp',pedidos:'📦 Pedidos','pedido-manual':'🧾 Criar Pedido (venda WhatsApp)',cupons:'🎟 Cupons',grupos:'📲 Grupos VIP',bundle:'🎁 Bundle',recuperacao:'💬 Recuperação de Carrinhos',atendimento:'🎧 Atendimento'};
...
function renderAba(aba, force) {
  var fns = {home:renderHome, relatorios:renderRelatorios, carrinhos:renderCarrinhos, ofertas:renderOfertas, pedidos:renderPedidos, 'pedido-manual':renderPedidoManual, cupons:renderCupons, grupos:renderGrupos, bundle:renderBundle, recuperacao:renderRecuperacao, roleta:renderRoleta, atendimento:renderAtendimento};
