...
app.get('/pdf/:orderId', async (req, res) => {
  ...
  try {
    ...
    // Aguardar a DACE carregar completamente
    await new Promise(r => setTimeout(r, 5000));
    // Verificar se a DACE está na página
    const pageContent = await page.content();
    console.log('Pagina tem DACE:', pageContent.includes('DACE') || pageContent.includes('Declaração'));
