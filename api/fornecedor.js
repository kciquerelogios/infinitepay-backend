export default async function handler(req, res) {
  ...
  return res.status(200).send(
    ...
    '  var bgC={enviado:"bg bfn",nao_enviado:"bg bpd",enviado_diferente:"bg bd2"};var bgD={enviado:"bm",nao_enviado:"bn",enviado_diferente:"bd"};' +
